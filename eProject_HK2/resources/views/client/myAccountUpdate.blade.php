        ...
        <div class="row" style=" margin-left: 400px">
            <div class="offset-md-3 col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ url('postAccountUpdate') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="txt-name" name="FNAME" placeholder="First Name" value="{{ $user->FNAME }}" required>
                            </div>
                            <div class="form-group">
                                <label for="txt-price">Last Name</label>
                                <input type="text" class="form-control" id="txt-price" name="LNAME" placeholder="1" value="{{ $user->LNAME }}" required>
                            </div>
                            <div class="form-group">
                                <label>ADDRESS</label>
                                <input class="form-control" rows="3" name="ADDRESS" placeholder="ADDRESS" value="{{ $user->ADDRESS }}" required>
                            </div>
                            <div class="form-group">
                                <label>PHONE</label>
                                <input class="form-control" rows="3" name="PHONE" placeholder="PHONE" value="{{ $user ->PHONE }}" required>
                            </div>
                        </div>
                        <!-- /.card-body -->
