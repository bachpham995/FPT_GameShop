...
Route::get('/newproducts','GameShopController@productsByNew');
Route::get('/saleproducts','GameShopController@productsBySale');
Route::get('/topproducts','GameShopController@productsByTop');
